...
function sumArray(array) {
  ...
  for (const n of array) {
    // я зрозумів що у завданні повинно було стояти не in a of і щоб не витрачати час на питання у підтримку зробив саме через of
...
// видаліть третій елемент масиву та перетворіть кожен елемент в рядок за допомогою методу toString().
...
// Завдання 5: Дано масив рядків. За допомогою циклу for переберіть масив, виведіть кожен елемент на консоль у
// верхньому регістрі.
...
function concatenateStrings(array, subString) {
  ...
  for (const n of array) {
    ...
    if (n.toString() === subString) {
      istrue = n.toString() === subString;
    }
  }
...
console.log(addTenToEach([5, 10, 15, 20])); // Виведе [15, 20, 25, 30]
...
function swapMinMax(array) {
  ...
  // Використовуємо цикл for для ітерації по масиву. Починаємо з першого елемента (i = 0) і продовжуємо
  // до останнього елемента масиву (i < array.length).
...
// Завдання 13: Функція приймає масив чисел. Повертає новий масив, в якому всі числа більші за 10 замінені на
// рядок "Greater than 10", а решта чисел замінені на рядок "Less than or equal to 10".
